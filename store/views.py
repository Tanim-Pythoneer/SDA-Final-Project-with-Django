...
def cart_detail(request, total=0, counter=0, cart_items = None):
    ...
    description = 'Simply Sweets - New Order'
...
def sendEmail(order_id):
    ...
    try:
        subject = "Simply Sweets - New Order #{}".format(transaction.id)
        to = ['{}'.format(transaction.emailAddress)]
        from_email = "orders@sandbox19526d251a444b54be7e6a3a12cfc29f.mailgun.org"
        order_information = {
...
def contact(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            message_format = "{} has sent you a new message: \n\n{}".format(name, message)

            msg = EmailMessage(
                subject,
                message_format,
                to = ['mikeedubas@hotmail.com'],
